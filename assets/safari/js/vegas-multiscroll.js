...
$(document).ready(function(){
    ...
    $('.slideshow-home-left').vegas({
        slides: [
            { src: 'assets/safari/img/left-1.jpg' },
            { src: 'assets/safari/img/left-2.jpg' },
            { src: 'assets/safari/img/left-3.jpg' },
        ],
    ...
    $('.slideshow-home-right').vegas({
        slides: [
            { src: 'assets/safari/img/right-1.jpg' },
            { src: 'assets/safari/img/right-2.jpg' },
            { src: 'assets/safari/img/right-3.jpg' },
        ],
    ...
    $('.slideshow-about').vegas({
        slides: [
            { src: 'assets/safari/img/slide-1.jpg' },
            { src: 'assets/safari/img/slide-2.jpg' },
            { src: 'assets/safari/img/slide-3.jpg' },
        ],
